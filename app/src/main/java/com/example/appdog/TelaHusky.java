...
public class TelaHusky extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_husky);

        btEnviar = (Button) findViewById(R.id.btn_Envia_husky);
        btVoltar = (Button) findViewById(R.id.btn_voltar_Thusky);
        txtnome = (EditText) findViewById(R.id.text_nome_tHusky);
